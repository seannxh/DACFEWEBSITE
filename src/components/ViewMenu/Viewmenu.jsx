...
const ViewMenu = ({ handleDeleteMenu, isAdmin }) => {
  ...
  const renderMenuByDishType = (dishType) => {
    ...
    return (
      <div key={dishType}>
        <h3 className="flex justify-center my-1 font-bold text-3xl sm:text-2xl text-red-700">
          {dishType}
        </h3>
                ...
                >
                  <div className="lg:w-3/4 flex flex-col items-start p-4">
                    ...
                    <div className="self-start mt-2">
                      <button
                        type="submit"
                        className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-500 font-cursive mr-2"
                      >
                        Save
                      </button>
                      <button
                ...
                <>
                  ...
                  <div className="lg:w-1/4 flex justify-center">
                    <img
                      ...
                      onClick={() =>
                        handleImageClick(`${BASE_URL}${menu.foodImg}`)
                      }
                    />
                  </div>
                  {isAdmin && (
                    <div className="self-center mt-2">
                      <button
                        ...
                        className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-500 font-cursive ml-1 mr-2 mb-2"
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => handleDeleteMenu(menu._id)}
                        className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-500 font-cursive ml-1  mr-2"
                      >
                        Delete
                      </button>
                    </div>
